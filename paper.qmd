...
Here we briefly describe the Bayesian analysis model used to investigate... paBackground details and diagnostics are included in \[Appendix -\@sec-model-details\].
...
list("First model" = first_model),statistic = "mad", fmt = 2)
```
